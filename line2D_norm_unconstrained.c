...
//    x0a,x1a: weighted averages of x's and y's
void line2D_norm_unconstrained(double *x0, double *x1, double *w, double *w_const, int n, double *u, double &d, double &x0a, double &x1a)
{
